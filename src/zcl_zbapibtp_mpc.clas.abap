class ZCL_ZBAPIBTP_MPC definition
  public
...
public section.
  ...
  types:
TT_BAPIRET type standard table of TS_BAPIRET .
  types:
...
TT_MENSAGEM type standard table of TS_MENSAGEM .
  ...
  constants GC_BAPIRET type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'BAPIRET' ##NO_TEXT.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZBAPIBTP_MPC==============CP' ##NO_TEXT.

  methods DEFINE_BAPIRET
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
...
CLASS ZCL_ZBAPIBTP_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZBAPIBTP_SRV' ).
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'BAPIRET' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZBAPIBTP_MPC=>TS_BAPIRET' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'BAPIRETSet' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZBAPIBTP_MPC=>TS_MENSAGEM' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20240724151211'.                  "#EC NOTEXT
...
ls_text_element-parent_artifact_name   = 'BAPIRET'.                            "#EC NOTEXT
